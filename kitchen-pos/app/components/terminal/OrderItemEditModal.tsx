...
export default function OrderItemEditModal({
  ...
  // The parent mounts this only while an item is being edited, so props can
  // seed state directly - no reset effect needed.
      ...
      <div className="max-h-[60vh] overflow-y-auto p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-on-surface-variant">
            Base price: {formatCurrency(orderItem.item?.base_price || 0)}
          </p>
        </div>
